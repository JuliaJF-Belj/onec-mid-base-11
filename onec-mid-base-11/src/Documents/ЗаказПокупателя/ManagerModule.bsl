...
//
// Параметры:
//  КомандыСозданияНаОсновании - ТаблицаЗначений - коллекция команд создания на основании.
...
//                     Свойства:
//                      * ПриДобавленииКомандПечати - Булево - Истина, если команды печати добавляются.
...
//                   * Представление - Строка - представление команды печати.
//                   * Порядок - Число - порядок расположения команды.
...
// 
// Параметры:
//  МассивОбъектов - ДокументСсылка - объекты, для которых формируются печатные формы.
//  ПараметрыПечати - Структура - параметры печати.
//  КоллекцияПечатныхФорм - ТаблицаЗначений - коллекция печатных форм.
//  ОбъектыПечати - ЛюбаяСсылка - объекты печати.
